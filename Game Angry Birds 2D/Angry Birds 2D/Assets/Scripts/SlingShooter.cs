...
public class SlingShooter : MonoBehaviour
{
    ...
    // Membuat objek trajectory dan mengambil atribut dari kelas bawaan LineRenderer
    ...
    // Method ini dijalankan saat posisi mouse di drag
    // Method ini untuk mengubah posisi dari gameObject agar mengikuti gerakan mouse
    ...
    void DisplayTrajectory(float distance)
    {
        ...
        // segmentCount merupakan total titik yg digambarkan sebagai trajectory
        int segmentCount = 5;
        ...
        for (int i = 0; i < segmentCount; i++)
        {
            ...
            segments[i] = segments[0] + segVelocity * elapsedTime + 0.5f *
                Physics2D.gravity * Mathf.Pow(elapsedTime, 2);
        }
